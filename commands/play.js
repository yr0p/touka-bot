...
module.exports = {
  ...
  run: async function (client, message, args) {
    ...
    if (serverQueue) {
      ...
      .setAuthor("Song has been added to queue", "https://media.tenor.com/images/0bd14aa4a6fac14fd693fe5ea2b64d41/tenor.gif")
    ...
    const play = async (song) => {
      ...
      let thing = new MessageEmbed()
      .setAuthor("Started Playing Music!", "https://media.tenor.com/images/0bd14aa4a6fac14fd693fe5ea2b64d41/tenor.gif")
      .setThumbnail(song.img)
      .setColor("#535787")
      .addField("Name", song.title, true)
      .addField("Duration", song.duration, true)
